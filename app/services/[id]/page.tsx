...
export default function ServiceDynamicPage({ params }) {
  ...
  //   // Pehle check karein param mein hai, nahi toh state mein, nahi toh localStorage mein
  //   const finalClientId = localStorage.getItem("aa_client_id");
  //   console.log("dsdsadsadsadasdfghj", finalClientId);
  ...
  //       { client_id: aaClientId }, // Yahan ab sahi ID jayegi
  //       {
  //         headers: {
  ...
  //     // ...
  //   } catch (err) {
  //     console.error("Payload jo bheja gaya:", { client_id: finalClientId });
  //     // ... error handling
  //   } finally {
  //     setLoading(false);
  //   }
          ...
          <div className="p-4 ">
            ...
            {service.endpoint === "account-aggregator-v2/fetch-json-report" && aaClientId && (
              <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <button
                  onClick={() => fetchAAReport(aaClientId || localStorage.getItem("aa_client_id"))}
                  disabled={loading}
