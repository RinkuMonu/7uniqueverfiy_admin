          ...
          <div className={styles.rightSection}>
            ...
            <div className={styles.environmentToggle}>
              ...
              <div className={styles.iconLabel}>
                <TestTube
                  className={`${styles.icon} ${environment === "uat" ? styles.uatActive : styles.inactive
                    }`}
                />
                <span
                  className={
              ...
              <div className={styles.iconLabel}>
                <Server
                  className={`${styles.icon} ${environment === "live" ? styles.liveActive : styles.inactive
                    }`}
                />
                <span
                  className={
              ...
              <div className={styles.statusContainer}>
                <div
                  className={`${styles.statusDot} ${environment === "live" ? styles.liveDot : styles.uatDot
                    }`}
                />
                <span
                  className={
